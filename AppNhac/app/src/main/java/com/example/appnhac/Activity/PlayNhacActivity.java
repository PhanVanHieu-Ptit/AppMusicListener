...
public class PlayNhacActivity extends AppCompatActivity {
    ...
    SeekBar sktime;
    ImageButton imgplay, imgprepeat, imgnext, imgrandom, imgpre;
    ...
    private void eventClick() {
        ...
        imgprepeat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (repeat == false){
                    if (checkrandom==true){
                        checkrandom = false;
                        //imgprepeat.setImageResource(R.drawable.iconsyned);
                    ...
                    imgprepeat.setImageResource(R.drawable.iconrepeat);
                    repeat=false;
                }
            }
        });
    ...
    private  void init(){
        ...
        imgprepeat = findViewById(R.id.imagebuttonrepeat);
