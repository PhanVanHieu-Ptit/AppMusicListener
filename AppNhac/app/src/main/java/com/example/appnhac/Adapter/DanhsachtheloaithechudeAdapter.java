...
public class DanhsachtheloaithechudeAdapter extends RecyclerView.Adapter<DanhsachtheloaithechudeAdapter.ViewHolder>{
    Context context;
    ArrayList<TheLoai> theLoaiArrayList;

    public DanhsachtheloaithechudeAdapter(Context context, ArrayList<TheLoai> theLoaiArrayList) {
